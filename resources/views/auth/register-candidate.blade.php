                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div class="text-center">
                                    <h5 class="font-medium text-gray-700 dark:text-gray-100">Candidate Register</h5>
                                    <p class="mt-1 text-gray-500 dark:text-zinc-100/60"> Get your TalentOrbit Candidate account.
                                    </p>
                                </div>

                                <form method="POST" action="{{ route('register.candidate.submit') }}"
                                    ...
                                    <div class="col-span-2">
                                        <x-input-label for="image" :value="__('User Picture')" />
                                        <div class="mt-1 flex justify-end items-center">
                                            <span class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">

                                                <img id="preview" src="https://api.dicebear.com/9.x/notionists/svg"
